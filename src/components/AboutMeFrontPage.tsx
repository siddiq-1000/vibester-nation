...
export default function AboutMeFrontPage() {
  const [isModalOpen, setIsModalOpen] = useState(false);

  return (
    <div className="relative min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black overflow-hidden flex flex-col z-30">
      {/* Header Navigation */}
      <header className="absolute top-0 w-full z-50 px-4 md:px-12 py-4 md:py-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 pointer-events-none">
      ...
      {/* Footer */}
      <footer className="absolute bottom-0 w-full z-50 px-4 md:px-12 py-6 md:py-10 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 pointer-events-none">
        {/* Logo Left */}
        ...
        <div className="flex-1 flex justify-end flex-col items-end">
          <img src="/logo.png" className="w-12 md:w-16 pointer-events-none opacity-50 md:opacity-100" />
        </div>
      </footer>
